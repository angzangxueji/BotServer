...
public class BattleHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (fhr.uri().equals("/battle_platform.html")) {
            String html = "";
            FileInputStream fin = new FileInputStream("/home/fanjiaming/项目/TankServer/src/org/webPage/new_tank/html/battle_platform.html");
