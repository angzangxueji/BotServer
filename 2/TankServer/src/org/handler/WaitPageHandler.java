...
public class WaitPageHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (uri.equals("/please_wait.html")) {
            ...
            String html = "";
            FileInputStream fin = new FileInputStream("/home/pp/IdeaProjects/TankServer/src/org/webPage/new_tank/html/please_wait.html");
...
//            System.out.println("uri====>"+uri);
            ...
            i+=1;
            ch.setI(i);
            System.out.println("iiiiiiiiiiiiiiiiiiiiiiiiiiiii"+ch.getI());
//            response.release();
