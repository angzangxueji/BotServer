...
public class RegisterPageHandler  extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (uri.equals("/register.html")) {
            ...
            String html = "";
            FileInputStream fin = new FileInputStream("/home/pp/IdeaProjects/TankServer/src/org/webPage/new_tank/html/register.html");
...
//            System.out.println("uri====>"+uri);
            ...
            System.out.println("写出register.html响应");
            response.release();
        } else {
//            System.out.println("uri====>"+uri);
