...
public class RoomPageHandler extends ChannelInboundHandlerAdapter {
    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (uri.equals("/choose_room.html")) {
            String html = "";
            FileInputStream fin = new FileInputStream("/home/pp/IdeaProjects/TankServer/src/org/webPage/new_tank/html/choose_room.html");
...
//                        System.out.println("==============================css\n"+text);
                        ...
                        System.out.println("room----------->" + f.exists());
                        System.out.println("\n" + f.length() + "\n");
